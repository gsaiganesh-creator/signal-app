    ...
    <>
      ...
      {moreOpen && (
        <>
          ...
          <div style={{ position: 'fixed', bottom: 'calc(60px + env(safe-area-inset-bottom))', left: 0, right: 0, zIndex: 195, background: 'var(--surf)', borderTop: '1px solid var(--bdr)', borderRadius: '16px 16px 0 0', padding: '4px 0 4px', maxHeight: '75vh', overflowY: 'auto' }}>
