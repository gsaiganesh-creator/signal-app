...
export function RiskDisclosureContent({ backHref = '/dashboard' }: { backHref?: string }) {
  return (
    <div style={{ maxWidth: 800 }}>
      ...
      <div style={{ marginTop: 32, textAlign: 'center' }}>
        <Link href={backHref} style={{ fontSize: 13, color: 'var(--dim)', textDecoration: 'none' }}>← Back to Dashboard</Link>
      </div>
    </div>
  );
}
