...
export interface Database {
  public: {
    Tables: {
      profiles: {
        Row:    { id: string; email: string | null; full_name: string | null; avatar_url: string | null; plan: Plan; plan_expires_at: string | null; broker: string | null; has_seen_tour: boolean; created_at: string; updated_at: string };
        Insert: { id: string; email?: string | null; full_name?: string | null; avatar_url?: string | null; plan?: Plan; plan_expires_at?: string | null; broker?: string | null; has_seen_tour?: boolean };
        Update: { email?: string | null; full_name?: string | null; avatar_url?: string | null; plan?: Plan; plan_expires_at?: string | null; broker?: string | null; has_seen_tour?: boolean };
        Relationships: [];
      };
      portfolios: {
