...
const SignalLogo = () => (
  <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
    <defs>
      <linearGradient id="sgBg" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#0E1628"/>
        <stop offset="100%" stopColor="#070D1A"/>
      </linearGradient>
      <linearGradient id="sgLine" x1="2" y1="0" x2="24" y2="0" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#4F6FFA"/>
        <stop offset="100%" stopColor="#00D4A0"/>
      </linearGradient>
    </defs>
    <rect width="26" height="26" rx="5" fill="url(#sgBg)"/>
    <polyline points="2,19 7,14 10,16 15,9 19,11 24,5" stroke="url(#sgLine)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
