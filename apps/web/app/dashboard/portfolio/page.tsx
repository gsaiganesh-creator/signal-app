...
const inp: React.CSSProperties = { height:40, borderRadius:9, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:13, padding:'0 12px', fontFamily:'inherit', outline:'none', width:'100%' };
    ...
    return (
      <>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16, maxWidth:680, marginBottom:24 }}>
          ...
          <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:`1px solid ${portfolioCreated ? 'rgba(0,212,160,0.4)' : 'var(--bdr)'}`, borderRadius:16, padding:'24px' }}>
          ...
          {/* Step 2 — Upload */}
          <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:`1px solid ${!portfolioCreated ? 'rgba(255,255,255,0.04)' : 'var(--bdr)'}`, borderRadius:16, padding:'24px', opacity: portfolioCreated ? 1 : 0.45 }}>
            <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:14 }}>
        ...
        {/* Broker format guide */}
        <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:12, padding:'14px 18px', maxWidth:680, fontSize:12 }}>
    ...
    <>
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:16, flexWrap:'wrap', gap:12 }}>
        ...
        <div style={{ display:'flex', gap:8 }}>
          <button onClick={() => fileRef.current?.click()} disabled={syncing || !activeId}
            style={{ height:36, padding:'0 16px', borderRadius:9, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:13, fontWeight:600, cursor:'pointer', fontFamily:'inherit', opacity: syncing ? 0.6 : 1 }}>
          ...
          <button onClick={() => enrichHoldings(rawHoldings)} disabled={loading}
            style={{ height:36, padding:'0 12px', borderRadius:9, background:'transparent', border:'1px solid rgba(79,111,250,0.22)', color:'var(--dim)', fontSize:13, cursor:'pointer', fontFamily:'inherit' }}>🔄</button>
        </div>
      </div>
        ...
        {portfolios.map(p => {
          ...
          return (
            <div key={p.id} style={{ position:'relative', display:'inline-flex', alignItems:'center', gap:0 }}>
              {isRenaming ? (
                <>
                  ...
                  <button onClick={() => setRenamingId(null)}
                    style={{ height:34, padding:'0 8px', marginLeft:4, borderRadius:8, background:'transparent', border:'1px solid rgba(79,111,250,0.22)', color:'var(--dim)', fontSize:13, cursor:'pointer', fontFamily:'inherit' }}>✕</button>
                </>
              ) : (
                <>
              ...
              {/* Dropdown menu */}
              {menuId === p.id && menuPos && (
                <div style={{ position:'fixed', top:menuPos.top, left:menuPos.left, zIndex:9999, background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:10, boxShadow:'0 8px 32px rgba(0,0,0,0.45)', minWidth:160, padding:'4px 0' }}>
        ...
        {showNewPortfolio ? (
          <div style={{ display:'flex', gap:6, alignItems:'center' }}>
            ...
            <button onClick={() => { setShowNewPortfolio(false); setNewPortfolioName(''); }}
              style={{ height:34, padding:'0 10px', borderRadius:8, background:'transparent', border:'1px solid rgba(79,111,250,0.22)', color:'var(--dim)', fontSize:13, cursor:'pointer', fontFamily:'inherit' }}>✕</button>
          </div>
        ) : (
      ...
      {confirmDeleteId && (
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.6)', zIndex:100, display:'flex', alignItems:'center', justifyContent:'center' }}
          ...
          <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:16, padding:'28px 32px', maxWidth:400, width:'90%', boxShadow:'0 16px 48px rgba(0,0,0,0.5)' }}>
            ...
            <div style={{ display:'flex', gap:10 }}>
              <button onClick={() => setConfirmDeleteId(null)} disabled={deletingPortfolio}
                style={{ flex:1, height:42, borderRadius:10, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:14, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>
                Cancel
              </button>
      ...
      <div style={card}>
        ...
        {displayedLoading ? (
          ...
          <div style={{ textAlign:'center', padding:'40px 0' }}>
            ...
            <div style={{ background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', borderRadius:12, padding:'16px 20px', display:'inline-block', textAlign:'left', maxWidth:440 }}>
        ...
        return (
          <div onClick={() => setSelectedStock(null)}
            ...
            <div onClick={e => e.stopPropagation()}
              style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:20, width:'min(470px,95vw)', boxShadow:'0 24px 80px rgba(0,0,0,0.6)', maxHeight:'92vh', display:'flex', flexDirection:'column', overflow:'hidden' }}>
              ...
              <div style={{ padding:'18px 18px 14px', borderBottom:'1px solid var(--bdr)', flexShrink:0 }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:10 }}>
                  ...
                  <button onClick={() => setSelectedStock(null)}
                    style={{ background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', borderRadius:8, width:32, height:32, display:'flex', alignItems:'center', justifyContent:'center', cursor:'pointer', color:'var(--dim)', fontSize:15, flexShrink:0 }}>✕</button>
                </div>
                ...
                <div style={{ padding:'14px 18px', borderBottom:'1px solid var(--bdr)' }}>
                  ...
                  <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8, marginBottom:10 }}>
                    {[
                      ...
                      <div key={m.label} style={{ background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', borderRadius:9, padding:'9px 11px' }}>
                  ...
                  <div style={{ padding:'14px 18px', borderBottom:'1px solid var(--bdr)' }}>
                    ...
                    <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:7 }}>
                      {[
                        ...
                        <div key={ind.label} style={{ background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', borderRadius:9, padding:'9px 11px' }}>
                    ...
                    {d.bb_pct != null && (
                      <div style={{ marginTop:12 }}>
                        ...
                        <div style={{ position:'relative', height:6, background:'rgba(255,255,255,0.07)', borderRadius:3 }}>
                          ...
                          <div style={{ position:'absolute', top:'50%', left:`${Math.min(95,Math.max(5,d.bb_pct))}%`, transform:'translate(-50%,-50%)', width:12, height:12, borderRadius:'50%', background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'2px solid #4F6FFA', boxShadow:'0 0 0 2px var(--surf)' }}/>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <div style={{ padding:'12px 18px', borderTop:'1px solid var(--bdr)', flexShrink:0 }}>
                ...
                <div style={{ display:'flex', gap:7 }}>
                  <button onClick={e => { e.stopPropagation(); setEditingCostId(h.id); setEditCostVal(String(h.avg_price)); setSelectedStock(null); }}
                    style={{ flex:1, height:38, borderRadius:9, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:12, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>
                    ✏️ Edit Cost
                  </button>
