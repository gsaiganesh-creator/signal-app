    ...
    <>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:12, marginBottom:24 }}>
        {[
          ...
          <div key={s.lbl} style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:13, padding:18, textAlign:'center' as const }}>
      ...
      {/* Referral link box */}
      <div style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:14, padding:22, marginBottom:24 }}>
        ...
        <div style={{ display:'flex', gap:10, marginTop:10 }}>
          <input readOnly value={refLink} style={{ flex:1, height:48, borderRadius:11, background:'var(--surf2)', border:'1px solid var(--bdr)', color:'var(--grn)', fontSize:13, fontWeight:700, padding:'0 16px', fontFamily:'monospace', outline:'none', letterSpacing:0.5 }}/>
        ...
        <div style={{ display:'flex', gap:8, marginTop:12, flexWrap:'wrap' as const }}>
          ...
          <button onClick={copyLink} style={{ height:36, padding:'0 16px', borderRadius:9, fontSize:12, fontWeight:700, cursor:'pointer', fontFamily:'inherit', background:'var(--surf2)', border:'1px solid var(--bdr)', color:'var(--txt)', display:'flex', alignItems:'center', gap:6 }}>
            📧 Copy &amp; Email
          </button>
        </div>
      </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 340px', gap:16 }}>
        ...
        {/* Tiers + Rules */}
        <div>
          <div style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:14, overflow:'hidden', marginBottom:14 }}>
          ...
          <div style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:14, padding:22 }}>
