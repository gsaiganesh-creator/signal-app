export default function TwitterFeedPage() {
  return (
    <>
      {/* Hero card */}
      <div style={{ background:'linear-gradient(135deg,rgba(0,0,0,0.04),rgba(23,64,245,0.04))', border:'1px solid rgba(255,255,255,0.08)', borderRadius:20, padding:'32px 40px', marginBottom:28, display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:24 }}>
