      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:20, flexWrap:'wrap', gap:10 }}>
        ...
        <div style={{ display:'flex', gap:8 }}>
          <button onClick={fetchRates} disabled={ratesLoading}
            style={{ height:36, padding:'0 14px', borderRadius:9, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:12, fontWeight:600, cursor:'pointer', fontFamily:'inherit', opacity: ratesLoading ? 0.6 : 1 }}>
      ...
      <div style={{ ...card, marginBottom:20 }}>
        ...
        <div className="g3" style={{ display:'grid', gap:8 }}>
          {LIVE_PAIRS.map(pair => {
            ...
            return (
              <div key={pair.code} style={{ background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', borderRadius:10, padding:'12px 14px' }}>
