  ...
  return (
    <>
      ...
      <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:20, flexWrap:'wrap', gap:10 }}>
        ...
        {lastUpdated && <div style={{ fontSize:11, color:'var(--dim)', padding:'4px 10px', borderRadius:6, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)' }}>Updated {lastUpdated}</div>}
      </div>
