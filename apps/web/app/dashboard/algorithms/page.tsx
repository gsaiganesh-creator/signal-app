                  ...
                  <div style={{ filter:'blur(3px)', pointerEvents:'none', userSelect:'none', opacity:0.45 }}>
                    ...
                    <div style={{ display:'flex', gap:20, paddingTop:12, borderTop:'1px solid var(--bdr)', flexWrap:'wrap' }}>
                      ...
                      <div style={{ marginLeft:'auto', display:'flex', gap:6, alignItems:'center', flexWrap:'wrap' }}>
                        {a.tags.map(t => (
                          <span key={t} style={{ fontSize:10, color:'var(--dim)', background:'var(--surf2)', border:'1px solid var(--bdr)', borderRadius:20, padding:'2px 8px', fontWeight:600 }}>{t}</span>
                        ))}
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ display:'flex', alignItems:'flex-start', gap:14 }}>
                    ...
                    <div style={{ display:'flex', gap:6, flexShrink:0 }}>
                      <button
                        ...
                        style={{ height:34, padding:'0 12px', borderRadius:9, background:'var(--surf2)', border:'1px solid var(--bdr)', color:'var(--dim)', fontSize:12, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>
                    ...
                    <div style={{ marginTop:16 }}>
                      <div className="g2" style={{ display:'grid', gap:14 }}>
                        ...
                        <div>
                          ...
                          <div style={{ background:'#080f1e', borderRadius:10, padding:14, fontSize:11.5, fontFamily:'JetBrains Mono, monospace', lineHeight:1.7, color:'#a8d8a8', whiteSpace:'pre-wrap', wordBreak:'break-word', maxHeight:320, overflowY:'auto', border:'1px solid var(--bdr)' }}>
                            {a.logic}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
                            {a.params.map(p => (
                              <div key={p.label} style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'8px 12px', background:'var(--surf2)', borderRadius:8, border:'1px solid var(--bdr)' }}>
