  ...
  return (
    ...
    <>
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:22, flexWrap:'wrap', gap:12 }}>
        ...
        <button style={{ height:36, padding:'0 16px', borderRadius:9, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:13, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>📂 My Strategies (3)</button>
      </div>
      ...
      <div className="algo-main-grid">
        <div>
          {/* Step 1 */}
          <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:14, padding:20, marginBottom:16 }}>
          ...
          {/* Step 3 */}
          <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:`1px solid ${step===3 ? 'rgba(23,64,245,0.3)' : 'var(--bdr)'}`, borderRadius:14, padding:20, marginBottom:16 }}>
              ...
              {[
                ...
                <div key={p.label}>
                  ...
                  <input type="number" value={p.state} onChange={e => p.setState(e.target.value)} step="0.5" min="0.5" max="20"
                    style={{ height:36, padding:'0 12px', borderRadius:8, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:14, fontWeight:700, fontFamily:'inherit', outline:'none', width:'100%' }}/>
          ...
          <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:14, padding:20 }}>
            ...
            <div className="bt-stats-grid">
              {BT.map(b => (
                <div key={b.lbl} style={{ background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', borderRadius:11, padding:'12px 14px', textAlign:'center' }}>
            ...
            <button onClick={() => setShowCode(!showCode)}
              style={{ height:36, padding:'0 16px', borderRadius:9, background:'var(--surf2)', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:13, fontWeight:600, cursor:'pointer', fontFamily:'inherit', marginBottom:12 }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:14, padding:18 }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
              ...
              <button style={{ height:46, borderRadius:12, background:'transparent', border:'1px solid rgba(79,111,250,0.22)', color:'var(--txt)', fontSize:14, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>💾 Save Strategy</button>
