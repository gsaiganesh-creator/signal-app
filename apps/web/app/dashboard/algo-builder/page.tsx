  ...
  return (
    ...
    <>
      ...
      <div className="algo-main-grid">
        <div>
          {/* Step 1 */}
          <div style={{ background:'var(--card-bg)', border:'1px solid var(--card-bdr)', borderRadius:14, padding:20, marginBottom:16 }}>
              ...
              {[
                ...
                <div key={p.label}>
                  ...
                  <input type="number" value={p.state} onChange={e => p.setState(e.target.value)} step="0.5" min="0.5" max="20"
                    style={{ height:36, padding:'0 12px', borderRadius:8, background:'var(--surf2)', border:'1px solid var(--card-bdr)', color:'var(--txt)', fontSize:14, fontWeight:700, fontFamily:'inherit', outline:'none', width:'100%' }}/>
