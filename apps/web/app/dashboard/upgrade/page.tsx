    ...
    <>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:14, marginBottom:28 }}>
        {PLANS.map(p => {
          ...
          return (
            <div key={p.id} style={{ background:'var(--surf)', border:`2px solid ${'badge' in p && p.badge ? p.border : 'var(--bdr)'}`, borderRadius:18, padding:'22px 20px', position:'relative', display:'flex', flexDirection:'column' }}>
              {'badge' in p && p.badge && (
