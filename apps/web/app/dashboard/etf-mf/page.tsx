  ...
  return (
    <>
        ...
        <>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(280px,1fr))', gap:14 }}>
            {ETFS.map(e => {
              ...
              return (
                <div key={e.sym} style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:14, padding:18 }}>
            ...
            return (
              <div key={cat} style={{ marginBottom:20 }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
                  {funds.map(m => (
                    <div key={m.name} style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:13, padding:'16px 18px', display:'flex', alignItems:'flex-start', gap:14 }}>
                      ...
                      <div style={{ flex:1, minWidth:0 }}>
                        <div style={{ display:'flex', alignItems:'center', gap:8, flexWrap:'wrap', marginBottom:4 }}>
                          ...
                          <span style={{ fontSize:10, padding:'2px 7px', borderRadius:5, background:'var(--surf2)', color:'var(--dim)', border:'1px solid var(--bdr)' }}>{m.type}</span>
      ...
      {tab === 'compare' && (
        <>
          {/* Decision guide */}
          <div style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:16, padding:20, marginBottom:20 }}>
      ...
      {tab === 'holdings' && (
        <>
          ...
          {showAdd && (
            <div style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:14, padding:20, marginBottom:20 }}>
          ...
          {holdings.length === 0 ? (
            <div style={{ textAlign:'center', padding:'48px 20px', background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:14 }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
              {holdings.map(h => {
                ...
                return (
                  <div key={h.id} style={{ background:'var(--surf)', border:'1px solid var(--bdr)', borderRadius:14, padding:'16px 20px' }}>
                    <div style={{ display:'flex', alignItems:'flex-start', gap:12 }}>
                      ...
                      <button onClick={() => removeHolding(h.id)}
                        style={{ width:28, height:28, borderRadius:7, background:'transparent', border:'1px solid var(--bdr)', color:'var(--dim)', cursor:'pointer', fontSize:13, flexShrink:0, display:'flex', alignItems:'center', justifyContent:'center' }}>✕</button>
                    </div>
                  </div>
                );
              })}
