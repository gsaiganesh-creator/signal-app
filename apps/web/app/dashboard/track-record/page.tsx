    ...
    <>
      ...
      <div className="tr-stats-grid" style={{ marginBottom:24 }}>
        {[
          ...
          <div key={s.label} style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:13, padding:'16px 18px' }}>
      ...
      <div style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:14, padding:20, marginBottom:24 }}>
      ...
      {tab === 'sectors' && (
        <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
          {topSectors.map(s => (
            <div key={s.sector} style={{ background:'linear-gradient(145deg,rgba(17,36,80,0.72),rgba(8,14,42,0.82))', border:'1px solid rgba(79,111,250,0.22)', borderRadius:12, padding:'14px 18px', display:'flex', alignItems:'center', gap:16 }}>
