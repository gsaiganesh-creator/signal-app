  ...
  return (
    <>
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:20, flexWrap:'wrap', gap:12 }}>
        ...
        <Link href="/algo-builder" style={{ height:36, padding:'0 18px', borderRadius:9, background:'var(--blu)', border:'none', color:'#fff', fontSize:13, fontWeight:700, display:'inline-flex', alignItems:'center' }}>+ New Strategy</Link>
      </div>
      ...
      <div style={{ display:'flex', gap:10, marginBottom:24, flexWrap:'wrap' }}>
        ...
        <Link href="/algo-builder" style={{ padding:'10px 20px', borderRadius:12, background:'var(--surf)', border:'1px dashed var(--bdr)', opacity:0.6, display:'flex', flexDirection:'column', justifyContent:'center' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 300px', gap:16 }}>
        ...
        <div>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
            ...
            <Link href="/algo-builder" style={{ height:44, borderRadius:12, background:'rgba(139,92,246,0.1)', border:'1px solid rgba(139,92,246,0.3)', color:'var(--pur)', fontSize:14, fontWeight:700, display:'flex', alignItems:'center', justifyContent:'center' }}>⚙️ Edit in Algo Builder</Link>
