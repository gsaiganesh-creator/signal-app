// Batch fundamental data for NSE stocks — lightweight quoteSummary fetch
// Used by fundamental screener tab on signals page
// Client calls with batches of 20 symbols; results merged client-side
...
export type FundStock = {
  ...
  market_cap: number | null;   // raw INR
};
...
// NSE scan universe: ~80 liquid stocks across all sectors
...
export async function GET(req: Request) {
  ...
  // If specific symbols requested, scan only those (client batching mode)
