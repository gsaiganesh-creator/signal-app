...
// INR/India only — USD/international checkout goes through Stripe instead
// (api/stripe/create-checkout-session), routed client-side by /api/geo's
// country detection. Razorpay is India-first infra; Stripe is the more
// reliable path for USD rather than depending on Razorpay's separate
// "International Payments" approval.
